...
<div class="popup-block" style="width: 100%; height: 300px; overflow: auto;">
    <div style="margin-bottom: 20px;">
        ...
        <div *ngIf="isExampleRows" style="width: 100%;"><img src="./public/images/templates/time-as-rows-example.png" style="max-width: 100%; height: auto; padding-right: 10px;"></div>
        <div>
        ...
        <div *ngIf="isExampleColumns" style="width: 100%;"><img src="./public/images/templates/time-as-columns-example.png" style="max-width: 100%; height: auto; padding-right: 10px;"></div>
    </div>
    ...
    <div style="margin-bottom: 20px;">
        ...
        <div *ngIf="file" class="btn-group">
            <label class="btn btn-default" style="background-color: #f4f4f4; border-color: #a5a5a5;" [(ngModel)]="delimiter" btnRadio="," uncheckable> , </label>
            <label class="btn btn-default" style="background-color: #f4f4f4; border-color: #a5a5a5;" [(ngModel)]="delimiter" btnRadio=";" uncheckable> ; </label>
        </div>
    </div>
</div>
