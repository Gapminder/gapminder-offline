...
pack(platform, arch, err => {
  ...
  const cmd = {
    'x64': {
      ...
      win32: 'copy invisible.vbs \"release\\Gapminder Offline-win32-x64\\invisible.vbs\" && copy update-app-win64.exe \"release\\Gapminder Offline-win32-x64\\update-app-win64.exe\" && copy update-dataset-win.exe \"release\\Gapminder Offline-win32-x64\\update-dataset-win64.exe\" && cd \"release\\Gapminder Offline-win32-x64\\resources\\app\" && npm i electron-easy-updater fs-extra zip-dir semver universal-analytics is-online'
    },
    'ia32': {
      win32: 'copy invisible.vbs \"release\\Gapminder Offline-win32-ia32\\invisible.vbs\" && copy update-app-win32.exe \"release\\Gapminder Offline-win32-ia32\\update-app-win32.exe\" && copy update-dataset-win.exe \"release\\Gapminder Offline-win32-ia32\\update-dataset-win32.exe\" && cd \"release\\Gapminder Offline-win32-ia32\\resources\\app\" && npm i electron-easy-updater fs-extra zip-dir semver universal-analytics is-online'
    }
  };
