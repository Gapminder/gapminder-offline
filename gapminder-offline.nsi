...
Section "Gapminder Offline tool" SecMain
  ...
  CreateShortcut "$desktop\Gapminder Offline Tool.lnk" "$INSTDIR\Gapminder Offline.exe"
SectionEnd
...
Section "Uninstall"
  ...
  Delete "$desktop\Gapminder Offline Tool.lnk"
